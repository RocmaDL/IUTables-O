  ...
  return (
    <header className="border-b border-border">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-2 md:px-8">
        {/* Logotype : le « O » final dans une case de voie, comme les distances. */}
        <Link
          href="/"
          className="flex min-h-11 items-center rounded-md pr-2 font-display text-2xl font-bold leading-none tracking-[-0.01em]"
        >
          IUTables&rsquo;
